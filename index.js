...
const intToOutcome = ['Dolla Won!', 'Draw!', 'Ahmed Won!'];
...
class Player extends React.Component {
  ...
  seeResult(i) { this.setState({view: 'Done', result: intToOutcome[i]}); }
  tellTimeout() { this.setState({view: 'Timeout'}); }
